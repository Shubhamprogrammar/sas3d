...
export const team: TeamMember[] = [
  {
    ...
    bio: "Abhishek founded Craftlab in 2016 after a decade across agencies and startups. He leads every engagement from discovery to delivery and still designs every Tuesday.",
  ...
  },
  {
    ...
    bio: "Maya turns messy problems into clean, usable interfaces. She's obsessed with typography, motion and making complex products feel simple.",
  ...
  },
  {
    ...
    bio: "David builds fast, accessible web apps that stay fast as they scale. He cares about the last millisecond as much as the first.",
